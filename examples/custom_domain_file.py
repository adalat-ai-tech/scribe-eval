...
print(f"\nLegal Domain - ER_DOMAIN: {report['LEGAL']['error_rate']:.2%}")
...
print(f"  ER_DOMAIN: {report_custom[custom_domain.category]['error_rate']:.2%}")
print(
...
print(f"\nInline Custom Domain - ER_DOMAIN: {report_inline['CUSTOM']['error_rate']:.2%}")
